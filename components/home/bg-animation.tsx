...
const BackgroundAnimation = () => {
  return (
    <div
      className="absolute -z-10 -translate-y-32 md:-translate-y-44 w-[100%] h-[100%] md:w-[500px] md:h-[500px]"
    >
      <div className="hero-image hidden dark:block">
        <svg
      ...
      <div className="hero-image block dark:hidden">
        <svg
          className="BgAnimation__svg"
          viewBox="0 0 602 602"
          fill="none"
