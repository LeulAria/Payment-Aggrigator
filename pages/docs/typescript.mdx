...
**Payment Aggrigator** provides typing out of the box, but this page contains some further utilities and tips.
...
**Payment Aggrigator** doesn't offer a way to make variants required yet, but you can use TypeScript's [Utility Types](https://www.typescriptlang.org/docs/handbook/utility-types.html) to achieve this.
