...
<Callout type="info">
  <div className="text-sm">
    **AdwaPay** will automatically select the correct variant for each
    slot.
  </div>
</Callout>
...
**AdwaPay** also allows you to apply responsive variants to your slots. See more about responsive variants [here](/docs/responsive-variants).
