...
**AdwaPay** allows you to add responsive variants by using the predefined breakpoints in Tailwind CSS. Read more about responsive design in the [Tailwind CSS documentation](https://tailwindcss.com/docs/responsive-design).
