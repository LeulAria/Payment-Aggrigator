...
<Callout type="info">
  <div className="text-sm">
    **StrategyTaps** will automatically select the correct variant for each
    slot.
  </div>
</Callout>
...
**StrategyTaps** also allows you to apply responsive variants to your slots. See more about responsive variants [here](/docs/responsive-variants).
